...
class SimpleQueue:
    ...
    def dequeue(self):
        ...
        return self.items.pop(0)  # Elimina y retorna el primer elemento (FIFO)

    def is_empty(self):
        return len(self.items) == 0  # Devuelve True si la cola está vacía

    def __len__(self):
        return len(self.items)  # Permite usar len(cola) para obtener el número de elementos
...
# Clase principal que gestiona la simulación del semáforo
class TrafficLightSimulation:
    def __init__(self, green_duration, total_time=10):
        ...
        self.total_time = total_time  # Tiempo total de la simulación
...
# Casos de prueba: se crea una simulación con duración de 4 unidades de tiempo y luz verde alternando cada 3
